...
export default function EndScreen({ stats, onRestart }: Props) {
  ...
  return (
    <div className="h-screen w-full max-w-full desk-surface flex items-center justify-center relative overflow-hidden">
      ...
      <div className="flex gap-6 items-start max-w-4xl w-full px-6">
        ...
        >
          ...
          <div className="flex items-center gap-5 mb-6">
            <div
              className="flex items-center justify-center font-typewriter font-bold rounded"
              style={{
                width: 80, height: 80,
